...
def get_diffface_train(base_url: str | None = None):
    base_url = base_url or get_base_url()

    diff_prefix = f"{base_url}/diffusion_face"
    celeba_prefix = f"{base_url}/mm_celeba_hq"
    ...
    return train_ai, train_real


def get_diffface_eval(base_url: str | None = None):
    base_url = base_url or get_base_url()
